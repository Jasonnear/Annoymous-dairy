var Recorder = {
  ...
  _setupFlashContainer: function(){
    ...
    this.options.flashContainer.setAttribute("id", "recorderFlashContainer");//solid rgba(128, 128, 128, 0.6)   solid rgba(128, 128, 128, 0.6)
    this.options.flashContainer.setAttribute("style", "position: fixed; left: -9999px; top: -9999px; width: 230px; height: 140px; margin-left: 10px; border-top: 6px; border-bottom: 6px; border-radius: 5px 5px; padding-bottom: 1px; padding-right: 1px;");
  ...
  _defaultOnShowFlash: function(){
    ...
    flashContainer.style.left   = 820 + "px";
    flashContainer.style.top    = 600  + "px";
  },
  ...
  _showFlashRequiredDialog: function(){
    ...
    Recorder.options.flashContainer.style.position = "absolute";
